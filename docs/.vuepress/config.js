module.exports = {
  ...
  themeConfig: {
    ...
    project: {
      ...
      testnet_denom: 'ISLM',
      testnet_ticker: 'ISLM',
      rpc_ws_url: 'https://rpc-ws.eth.haqq.network:8546/',
      rpc_eth_url: 'https://rpc.eth.haqq.network:8545',
      rpc_tm_url: 'https://rpc.tm.haqq.network:26657',
      grpc_cosmos_url: 'https://grpc.cosmos.haqq.network:9090',
      rest_api_url: 'https://rest.cosmos.haqq.network:1317',
    ...
    footer: {
      ...
      textLink: {
        //text: 'Haqq Network',
        url: 'https://islamiccoin.net/haqq-network'
      },
      services: [
        {
          service: 'github',
